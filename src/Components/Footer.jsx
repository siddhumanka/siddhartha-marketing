                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <a href="tel:+919422163831" className="flex items-center gap-3 text-slate-300 hover:text-blue-300 transition-colors">
                                <Phone className="w-5 h-5" />
                                <span>+91 94221 63831</span>
                            </a>
                            <a href="mailto:mankashyam@gmail.com" className="flex items-center gap-3 text-slate-300 hover:text-blue-300 transition-colors">
